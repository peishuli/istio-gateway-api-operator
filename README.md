...
- [x] **Canary / Traffic Splitting** — `spec.canary` now supports weighted primary/secondary splits plus probe-driven automatic rollback to stable on consecutive canary 5xx responses.
